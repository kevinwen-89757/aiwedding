export const appConfig = {
  ...
  apimartTimeoutMs: Number.parseInt(process.env.APIMART_TIMEOUT_MS ?? "180000", 10),
  generationTestLimit: process.env.GENERATION_TEST_LIMIT ? Number.parseInt(process.env.GENERATION_TEST_LIMIT, 10) : null,
