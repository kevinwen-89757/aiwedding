...
━━━━━━━━━━━━━━━━━━━━`,
  ...
  makeTheme({
    ...
    themeName: "赫本·永恒经典",
    themeDescription: "低饱和米灰色调搭配黑白电影质感，极简高级，呈现经典好莱坞黄金时代的优雅叙事。",
    suitableFor: "适合追求赫本气质、极简高级感、黑白电影质感的用户。",
    defaultAspectRatio: "3:4",
    ...
    prompts: [
      {
        name: "A",
        prompt: `以@Image @Image 人物为原型，去除所有背景服饰和发型，再生成写真：\n\n核心任务：超高清竖构图（3:4）。赫本风格复古优雅婚纱合影。低饱和米灰色调搭配黑白电影质感，极简高级。光线柔和富有戏剧感，呈现经典好莱坞黄金时代的优雅叙事。\n\n一、人物绑定（最高优先级）\n人物：严格使用您上传的肖像。男性为新郎，身形挺拔，颈部舒展，形体严禁佝偻。女性为新娘，身形柔美优雅，体态轻盈挺拔，皮肤白皙通透，肤质细腻干净，具有女性特有的曲线与气质，温婉端庄。肖像保真：100%沿用原图五官、脸型、肤色，禁止修改。眼神清澈明亮，严禁小眼睛或变形。\n\n二、造型细节\n新娘：身着简约缎面修身婚纱，面料具有柔和光泽感；佩戴短款透明头纱，边缘精致；发型为黑色复古盘发，一丝不苟。佩戴高质感珍珠项链与珍珠耳饰，折射出柔和珠光。妆容精致干净，哑光肤质，红唇点睛，呈现1950年代赫本经典妆感。\n新郎：穿着笔挺的黑色西装搭配白色衬衫与黑色领结。发型为黑色复古背头，打理得整洁油亮。妆容干净自然，呈现出沉稳绅士的高级感。\n\n三、场景与画质\n场景：古典欧式建筑内景，大理石楼梯或拱形门廊，线条简洁富有几何美感。低饱和米灰色调，光影层次分明。\n光影与画质：柔光从侧上方打亮人物面部轮廓，明暗过渡细腻。脸部带有经典好莱坞式的柔和戏剧感。皮肤干净细腻，无脏污粗糙感。保留细腻胶片颗粒感，具有高级黑白电影的复古质感。\nNegative Prompt: no slouching, no oily skin, no overexposure, no blurred face, no dull skin, no dark skin, no sallow complexion, no dirty skin, no rough skin, no blemishes, no tears, no crying, no sad expression, no bright colors, no neon, no casual style.\n\n四、分镜动作\nMedium full-length vertical shot (3:4), classic Hollywood elegance. The couple stands side by side on a grand marble staircase, the bride turning slightly towards the camera with a graceful, poised expression, one hand gently holding the groom's arm. The groom looks at her with quiet admiration. Soft dramatic light from above sculpts their features. Timeless and sophisticated atmosphere. --ar 3:4`,
        rawPrompt: `以@Image @Image 人物为原型，去除所有背景服饰和发型，再生成写真： 核心任务：超高清竖构图（3:4）。赫本风格复古优雅婚纱合影。低饱和米灰色调搭配黑白电影质感，极简高级。光线柔和富有戏剧感，呈现经典好莱坞黄金时代的优雅叙事。 一、人物绑定（最高优先级） 人物：严格使用您上传的肖像。男性为新郎，身形挺拔，颈部舒展，形体严禁佝偻。女性为新娘，身形柔美优雅，体态轻盈挺拔，皮肤白皙通透，肤质细腻干净，具有女性特有的曲线与气质，温婉端庄。肖像保真：100%沿用原图五官、脸型、肤色，禁止修改。眼神清澈明亮，严禁小眼睛或变形。 二、造型细节 新娘：身着简约缎面修身婚纱，面料具有柔和光泽感；佩戴短款透明头纱，边缘精致；发型为黑色复古盘发，一丝不苟。佩戴高质感珍珠项链与珍珠耳饰，折射出柔和珠光。妆容精致干净，哑光肤质，红唇点睛，呈现1950年代赫本经典妆感。 新郎：穿着笔挺的黑色西装搭配白色衬衫与黑色领结。发型为黑色复古背头，打理得整洁油亮。妆容干净自然，呈现出沉稳绅士的高级感。 三、场景与画质 场景：古典欧式建筑内景，大理石楼梯或拱形门廊，线条简洁富有几何美感。低饱和米灰色调，光影层次分明。 光影与画质：柔光从侧上方打亮人物面部轮廓，明暗过渡细腻。脸部带有经典好莱坞式的柔和戏剧感。皮肤干净细腻，无脏污粗糙感。保留细腻胶片颗粒感，具有高级黑白电影的复古质感。 Negative Prompt: no slouching, no oily skin, no overexposure, no blurred face, no dull skin, no dark skin, no sallow complexion, no dirty skin, no rough skin, no blemishes, no tears, no crying, no sad expression, no bright colors, no neon, no casual style. 四、分镜动作 Medium full-length vertical shot (3:4), classic Hollywood elegance. The couple stands side by side on a grand marble staircase, the bride turning slightly towards the camera with a graceful, poised expression, one hand gently holding the groom's arm. The groom looks at her with quiet admiration. Soft dramatic light from above sculpts their features. Timeless and sophisticated atmosphere. --ar 3:4`,
        aspectRatio: "3:4",
        scene: "赫本·永恒经典",
        pose: "A",
        styleTags: []
      ...
      {
        name: "B",
        prompt: `以@Image @Image 人物为原型，去除所有背景服饰和发型，再生成写真：\n\n核心任务：超高清竖构图（3:4）。新娘单人竖幅肖像。赫本风格复古优雅，低饱和米灰色调，极简高级。新娘侧身回眸，气质优雅从容，黑白电影质感。\n\n一、人物绑定（最高优先级）\n人物：仅出现女性，新娘单人。严格使用上传的新娘肖像，100%沿用原图五官、脸型、肤色，禁止修改。新娘身形柔美优雅，体态轻盈挺拔，皮肤白皙通透，肤质细腻干净，曲线优雅自然，严禁缩脖、耸肩、臃肿。新郎本张不出镜。\n\n二、造型细节\n新娘：简约缎面修身婚纱，短款透明头纱。黑色复古盘发一丝不苟，高质感珍珠项链与珍珠耳饰。精致哑光妆容，红唇点睛，呈现1950年代赫本经典妆感。\n新郎：本张为新娘单人照，新郎不出现。\n\n三、场景与画质\n场景：古典拱形门廊或大理石窗台前，自然柔光从侧面透入，光影层次细腻。低饱和米灰色调。\n光影与画质：侧光勾勒新娘面部轮廓与珍珠耳饰的柔和珠光。新娘回眸瞬间优雅从容，红唇与白皙肤色形成精致对比。皮肤干净细腻，无脏污粗糙感。保留细腻胶片颗粒感。\nNegative Prompt: no groom, no third person, no slouching, no oily skin, no overexposure, no blurred face, no dull skin, no dark skin, no sallow complexion, no dirty skin, no rough skin, no blemishes, no tears, no crying, no sad expression, no bright colors, no casual style.\n\n四、分镜动作\nFull-length vertical portrait (3:4), classic Hepburn-inspired elegance. The bride stands by a marble window frame, turning her head slightly back over her shoulder in a graceful three-quarter profile, her expression serene and poised. One hand rests gently on the window sill, the other holds her veil. Soft natural light from the side illuminates her pearl earrings and red lips. Timeless and sophisticated atmosphere. --ar 3:4`,
        rawPrompt: `以@Image @Image 人物为原型，去除所有背景服饰和发型，再生成写真： 核心任务：超高清竖构图（3:4）。新娘单人竖幅肖像。赫本风格复古优雅，低饱和米灰色调，极简高级。新娘侧身回眸，气质优雅从容，黑白电影质感。 一、人物绑定（最高优先级） 人物：仅出现女性，新娘单人。严格使用上传的新娘肖像，100%沿用原图五官、脸型、肤色，禁止修改。新娘身形柔美优雅，体态轻盈挺拔，皮肤白皙通透，肤质细腻干净，曲线优雅自然，严禁缩脖、耸肩、臃肿。新郎本张不出镜。 二、造型细节 新娘：简约缎面修身婚纱，短款透明头纱。黑色复古盘发一丝不苟，高质感珍珠项链与珍珠耳饰。精致哑光妆容，红唇点睛，呈现1950年代赫本经典妆感。 新郎：本张为新娘单人照，新郎不出现。 三、场景与画质 场景：古典拱形门廊或大理石窗台前，自然柔光从侧面透入，光影层次细腻。低饱和米灰色调。 光影与画质：侧光勾勒新娘面部轮廓与珍珠耳饰的柔和珠光。新娘回眸瞬间优雅从容，红唇与白皙肤色形成精致对比。皮肤干净细腻，无脏污粗糙感。保留细腻胶片颗粒感。 Negative Prompt: no groom, no third person, no slouching, no oily skin, no overexposure, no blurred face, no dull skin, no dark skin, no sallow complexion, no dirty skin, no rough skin, no blemishes, no tears, no crying, no sad expression, no bright colors, no casual style. 四、分镜动作 Full-length vertical portrait (3:4), classic Hepburn-inspired elegance. The bride stands by a marble window frame, turning her head slightly back over her shoulder in a graceful three-quarter profile, her expression serene and poised. One hand rests gently on the window sill, the other holds her veil. Soft natural light from the side illuminates her pearl earrings and red lips. Timeless and sophisticated atmosphere. --ar 3:4`,
        aspectRatio: "3:4",
        scene: "赫本·永恒经典",
        pose: "B",
        styleTags: []
      ...
      {
        name: "C",
        prompt: `以@Image @Image 人物为原型，去除所有背景服饰和发型，再生成写真：\n\n核心任务：超高清竖构图（3:4）。新郎单人竖幅肖像。赫本风格复古优雅，黑白电影质感。新郎伫立于古典建筑内，西装笔挺，气质沉稳从容。\n\n一、人物绑定（最高优先级）\n人物：仅出现男性，新郎单人。严格使用上传的新郎肖像，100%沿用原图五官、脸型、肤色，禁止修改。身形挺拔，颈部舒展，肩背宽阔，形体严禁佝偻。新娘本张不出镜。\n\n二、造型细节\n新郎：黑色西装搭配白色衬衫与黑色领结，剪裁合体。发型为黑色复古背头，打理得整洁油亮。妆容干净自然，呈现出沉稳绅士的高级感。\n新娘：本张为新郎单人照，新娘不出现。\n\n三、场景与画质\n场景：古典欧式建筑内，大理石台阶或拱形背景，线条简洁富有几何美感。低饱和米灰色调。\n光影与画质：柔光勾勒西装轮廓与面部线条，黑白灰过渡细腻。新郎伫立的姿态稳重大气，展现绅士风范。皮肤干净细腻，无脏污粗糙感。保留细腻胶片颗粒感。\nNegative Prompt: no bride, no third person, no slouching, no oily skin, no overexposure, no blurred face, no dull skin, no dark skin, no sallow complexion, no dirty skin, no rough skin, no blemishes, no bright colors.\n\n四、分镜动作\nFull-length vertical portrait (3:4), classic gentleman elegance. The groom stands tall on a marble staircase, facing slightly sideways with his hands in his pockets, looking off-camera with a calm, composed expression. The black suit and bow tie are crisp and impeccably tailored. Soft dramatic light sculpts his silhouette against the architectural backdrop. Refined and sophisticated atmosphere. --ar 3:4`,
        rawPrompt: `以@Image @Image 人物为原型，去除所有背景服饰和发型，再生成写真： 核心任务：超高清竖构图（3:4）。新郎单人竖幅肖像。赫本风格复古优雅，黑白电影质感。新郎伫立于古典建筑内，西装笔挺，气质沉稳从容。 一、人物绑定（最高优先级） 人物：仅出现男性，新郎单人。严格使用上传的新郎肖像，100%沿用原图五官、脸型、肤色，禁止修改。身形挺拔，颈部舒展，肩背宽阔，形体严禁佝偻。新娘本张不出镜。 二、造型细节 新郎：黑色西装搭配白色衬衫与黑色领结，剪裁合体。发型为黑色复古背头，打理得整洁油亮。妆容干净自然，呈现出沉稳绅士的高级感。 新娘：本张为新郎单人照，新娘不出现。 三、场景与画质 场景：古典欧式建筑内，大理石台阶或拱形背景，线条简洁富有几何美感。低饱和米灰色调。 光影与画质：柔光勾勒西装轮廓与面部线条，黑白灰过渡细腻。新郎伫立的姿态稳重大气，展现绅士风范。皮肤干净细腻，无脏污粗糙感。保留细腻胶片颗粒感。 Negative Prompt: no bride, no third person, no slouching, no oily skin, no overexposure, no blurred face, no dull skin, no dark skin, no sallow complexion, no dirty skin, no rough skin, no blemishes, no bright colors. 四、分镜动作 Full-length vertical portrait (3:4), classic gentleman elegance. The groom stands tall on a marble staircase, facing slightly sideways with his hands in his pockets, looking off-camera with a calm, composed expression. The black suit and bow tie are crisp and impeccably tailored. Soft dramatic light sculpts his silhouette against the architectural backdrop. Refined and sophisticated atmosphere. --ar 3:4`,
        aspectRatio: "3:4",
        scene: "赫本·永恒经典",
        pose: "C",
        styleTags: []
      ...
      {
        name: "D",
        prompt: `以@Image @Image 人物为原型，去除所有背景服饰和发型，再生成写真：\n\n核心任务：超高清横构图（16:9）。电影宽银幕质感，赫本风格复古优雅。古典建筑内景，低饱和米灰色调，黑白电影感。两人处于宽阔空间中，展现人物与空间之间的比例与叙事感。\n\n一、人物绑定（最高优先级）\n人物：严格使用您上传的肖像。男性为新郎，身形挺拔，形体严禁佝偻。女性为新娘，身形柔美优雅，体态轻盈，皮肤白皙通透，肤质细腻干净，曲线优雅自然。肖像保真：100%沿用原图五官、脸型、肤色，禁止修改。\n\n二、造型细节\n新娘：简约缎面修身婚纱，短款透明头纱。黑色复古盘发，珍珠项链与珍珠耳饰。精致哑光妆容，红唇点睛。\n新郎：黑色西装搭配白色衬衫与黑色领结，复古背头，整洁有型。\n\n三、场景与画质\n场景：古典欧式建筑大厅，大理石地面与拱形天花板形成纵深透视。大面积留白凸显人物。低饱和米灰色调。\n光影与画质：柔和自然光从高窗洒入，光影在空间中形成优美的明暗过渡。人物在宽幅画面中形成优雅剪影。皮肤干净细腻。保留细腻胶片颗粒感与电影叙事氛围。\nNegative Prompt: no slouching, no oily skin, no overexposure, no blurred face, no dull skin, no dark skin, no sallow complexion, no dirty skin, no rough skin, no blemishes, no tears, no crying, no sad expression, no bright colors.\n\n四、分镜动作\nWide cinematic shot (16:9). The couple stands in a grand marble hall, positioned slightly off-center for compositional elegance. The groom holds the bride's hand gently; she takes a graceful step forward, her veil trailing behind. Soft light from tall arched windows creates dramatic shadows across the floor. The vast space emphasizes their elegant silhouettes. Cinematic and timeless atmosphere. --ar 16:9`,
        rawPrompt: `以@Image @Image 人物为原型，去除所有背景服饰和发型，再生成写真： 核心任务：超高清横构图（16:9）。电影宽银幕质感，赫本风格复古优雅。古典建筑内景，低饱和米灰色调，黑白电影感。两人处于宽阔空间中，展现人物与空间之间的比例与叙事感。 一、人物绑定（最高优先级） 人物：严格使用您上传的肖像。男性为新郎，身形挺拔，形体严禁佝偻。女性为新娘，身形柔美优雅，体态轻盈，皮肤白皙通透，肤质细腻干净，曲线优雅自然。肖像保真：100%沿用原图五官、脸型、肤色，禁止修改。 二、造型细节 新娘：简约缎面修身婚纱，短款透明头纱。黑色复古盘发，珍珠项链与珍珠耳饰。精致哑光妆容，红唇点睛。 新郎：黑色西装搭配白色衬衫与黑色领结，复古背头，整洁有型。 三、场景与画质 场景：古典欧式建筑大厅，大理石地面与拱形天花板形成纵深透视。大面积留白凸显人物。低饱和米灰色调。 光影与画质：柔和自然光从高窗洒入，光影在空间中形成优美的明暗过渡。人物在宽幅画面中形成优雅剪影。皮肤干净细腻。保留细腻胶片颗粒感与电影叙事氛围。 Negative Prompt: no slouching, no oily skin, no overexposure, no blurred face, no dull skin, no dark skin, no sallow complexion, no dirty skin, no rough skin, no blemishes, no tears, no crying, no sad expression, no bright colors. 四、分镜动作 Wide cinematic shot (16:9). The couple stands in a grand marble hall, positioned slightly off-center for compositional elegance. The groom holds the bride's hand gently; she takes a graceful step forward, her veil trailing behind. Soft light from tall arched windows creates dramatic shadows across the floor. The vast space emphasizes their elegant silhouettes. Cinematic and timeless atmosphere. --ar 16:9`,
        aspectRatio: "16:9",
        scene: "赫本·永恒经典",
        pose: "D",
        styleTags: []
      ...
      {
        name: "E",
        prompt: `以@Image @Image 人物为原型，去除所有背景服饰和发型，再生成写真：\n\n核心任务：超高清横构图（16:9）。聚焦人物上半身，黑白电影质感赫本风格。两人亲密互动，面部表情优雅自然。低饱和米灰色调，柔光勾勒五官轮廓。\n\n一、人物绑定（最高优先级）\n人物：严格使用您上传的肖像。男性为新郎，身形挺拔。女性为新娘，身形柔美优雅，体态轻盈，皮肤白皙通透，肤质细腻干净，曲线优雅自然。肖像保真：100%沿用原图五官、脸型、肤色，禁止修改。\n\n二、造型细节\n新娘：简约缎面婚纱上身细节可见，珍珠项链与耳饰。红唇精致妆容。\n新郎：黑色西装搭配白色衬衫与领结。\n\n三、场景与画质\n场景：古典建筑内景，背景为大理石柱或拱形窗，柔和虚化凸显人物。低饱和米灰色调。\n光影与画质：柔和侧光打亮双人面部，红唇与白皙肤色形成精致对比。皮肤干净细腻。黑白过渡细腻，保留胶片颗粒感。\nNegative Prompt: no slouching, no oily skin, no overexposure, no blurred face, no dull skin, no dark skin, no sallow complexion, no dirty skin, no rough skin, no blemishes, no tears, no crying, no sad expression, no bright colors.\n\n四、分镜动作\nMedium close-up (16:9), intimate and elegant. The groom stands behind the bride, gently adjusting her pearl necklace, both looking at each other with tender, affectionate smiles. Her red lips and pearl earrings catch the soft light. The background columns fade into soft bokeh. Graceful and romantic atmosphere. --ar 16:9`,
        rawPrompt: `以@Image @Image 人物为原型，去除所有背景服饰和发型，再生成写真： 核心任务：超高清横构图（16:9）。聚焦人物上半身，黑白电影质感赫本风格。两人亲密互动，面部表情优雅自然。低饱和米灰色调，柔光勾勒五官轮廓。 一、人物绑定（最高优先级） 人物：严格使用您上传的肖像。男性为新郎，身形挺拔。女性为新娘，身形柔美优雅，体态轻盈，皮肤白皙通透，肤质细腻干净，曲线优雅自然。肖像保真：100%沿用原图五官、脸型、肤色，禁止修改。 二、造型细节 新娘：简约缎面婚纱上身细节可见，珍珠项链与耳饰。红唇精致妆容。 新郎：黑色西装搭配白色衬衫与领结。 三、场景与画质 场景：古典建筑内景，背景为大理石柱或拱形窗，柔和虚化凸显人物。低饱和米灰色调。 光影与画质：柔和侧光打亮双人面部，红唇与白皙肤色形成精致对比。皮肤干净细腻。黑白过渡细腻，保留胶片颗粒感。 Negative Prompt: no slouching, no oily skin, no overexposure, no blurred face, no dull skin, no dark skin, no sallow complexion, no dirty skin, no rough skin, no blemishes, no tears, no crying, no sad expression, no bright colors. 四、分镜动作 Medium close-up (16:9), intimate and elegant. The groom stands behind the bride, gently adjusting her pearl necklace, both looking at each other with tender, affectionate smiles. Her red lips and pearl earrings catch the soft light. The background columns fade into soft bokeh. Graceful and romantic atmosphere. --ar 16:9`,
        aspectRatio: "16:9",
        scene: "赫本·永恒经典",
        pose: "E",
        styleTags: []
      ...
      {
        name: "F",
        prompt: `以@Image @Image 人物为原型，去除所有背景服饰和发型，再生成写真：\n\n核心任务：超高清竖构图（3:4）。近景亲密互动，赫本风格复古优雅。两人面部贴近，眼神交流充满温情。红唇与白色衬衫形成经典黑白对比，细节毕现。\n\n一、人物绑定（最高优先级）\n人物：严格使用您上传的肖像。男性为新郎，身形挺拔。女性为新娘，身形柔美优雅，体态轻盈，皮肤白皙通透，肤质细腻干净，曲线优雅自然。肖像保真：100%沿用原图五官、脸型、肤色，禁止修改。\n\n二、造型细节\n新娘：珍珠耳饰与项链在近景中细节呈现。红唇精致，哑光妆容。\n新郎：白色衬衫领口整洁，领结精致。\n\n三、场景与画质\n场景：极简背景，纯色灰调或浅米色幕布。大面积留白凸显人物面部微表情。\n光影与画质：柔光从前方45度打亮面部，红唇与珍珠形成视觉焦点。皮肤干净细腻，纹理真实。黑白过渡细腻，保留胶片颗粒感与复古质感。\nNegative Prompt: no slouching, no oily skin, no overexposure, no blurred face, no dull skin, no dark skin, no sallow complexion, no dirty skin, no rough skin, no blemishes, no tears, no crying, no sad expression, no bright colors, no casual style.\n\n四、分镜动作\nMedium close-up vertical shot (3:4), intimate and refined. The groom gently holds the bride's chin, both faces close together, looking into each other's eyes with soft, loving smiles. Her red lips and pearl earring are sharply detailed. The bride's skin is luminous and flawless. The groom's white shirt collar frames the composition elegantly. Vintage Hollywood romantic atmosphere. --ar 3:4`,
        rawPrompt: `以@Image @Image 人物为原型，去除所有背景服饰和发型，再生成写真： 核心任务：超高清竖构图（3:4）。近景亲密互动，赫本风格复古优雅。两人面部贴近，眼神交流充满温情。红唇与白色衬衫形成经典黑白对比，细节毕现。 一、人物绑定（最高优先级） 人物：严格使用您上传的肖像。男性为新郎，身形挺拔。女性为新娘，身形柔美优雅，体态轻盈，皮肤白皙通透，肤质细腻干净，曲线优雅自然。肖像保真：100%沿用原图五官、脸型、肤色，禁止修改。 二、造型细节 新娘：珍珠耳饰与项链在近景中细节呈现。红唇精致，哑光妆容。 新郎：白色衬衫领口整洁，领结精致。 三、场景与画质 场景：极简背景，纯色灰调或浅米色幕布。大面积留白凸显人物面部微表情。 光影与画质：柔光从前方45度打亮面部，红唇与珍珠形成视觉焦点。皮肤干净细腻，纹理真实。黑白过渡细腻，保留胶片颗粒感与复古质感。 Negative Prompt: no slouching, no oily skin, no overexposure, no blurred face, no dull skin, no dark skin, no sallow complexion, no dirty skin, no rough skin, no blemishes, no tears, no crying, no sad expression, no bright colors, no casual style. 四、分镜动作 Medium close-up vertical shot (3:4), intimate and refined. The groom gently holds the bride's chin, both faces close together, looking into each other's eyes with soft, loving smiles. Her red lips and pearl earring are sharply detailed. The bride's skin is luminous and flawless. The groom's white shirt collar frames the composition elegantly. Vintage Hollywood romantic atmosphere. --ar 3:4`,
        aspectRatio: "3:4",
        scene: "赫本·永恒经典",
        pose: "F",
        styleTags: []
      ...
      {
        name: "G",
        prompt: `以@Image @Image 人物为原型，去除所有背景服饰和发型，再生成写真：\n\n核心任务：超高清横构图（3:2）。赫本风格收束画面，优雅纪实感。两人并肩行走于古典长廊，姿态从容优雅，衣摆微扬。远景中人物轮廓清晰，展现经典电影结尾般的诗意画面。\n\n一、人物绑定（最高优先级）\n人物：严格使用您上传的肖像。男性为新郎，身形挺拔，行走间体态舒展。女性为新娘，身形柔美优雅，体态轻盈挺拔，皮肤白皙通透，肤质细腻干净。肖像保真：100%沿用原图五官、脸型、肤色，禁止修改。远景中人物面部可稍小，但轮廓与姿态需清晰可辨。\n\n二、造型细节\n新娘：简约缎面修身婚纱，头纱向后微扬。珍珠耳饰随步伐轻轻摇曳。\n新郎：黑色西装笔挺，领结精致。\n\n三、场景与画质\n场景：古典拱形长廊，透视纵深强烈。暖灰色调，柔光从长廊一侧透入。\n光影与画质：远景中人物轮廓、头纱飘动轨迹、婚纱裙摆形态均需锐利清晰。长廊的光影透视增强了画面的叙事感和纵深。皮肤干净细腻。保留细腻胶片颗粒感，呈现经典黑白电影末尾般的诗意与余韵。\nNegative Prompt: no slouching, no oily skin, no overexposure, no blurred face, no dull skin, no dark skin, no sallow complexion, no dirty skin, no rough skin, no blemishes, no tears, no crying, no sad expression, no loss of detail, no pixelation, no bright colors.\n\n四、分镜动作\nWide landscape closing shot (3:2). The couple walks hand in hand down a long arched corridor, their elegant silhouettes framed by the receding columns. The bride turns her head slightly in three-quarter profile, her face catching the soft light from the side windows. Her veil and dress hem trail gracefully. The groom walks tall beside her, his posture refined. Timeless and poetic atmosphere, like the closing scene of a classic film. --ar 3:2`,
        rawPrompt: `以@Image @Image 人物为原型，去除所有背景服饰和发型，再生成写真： 核心任务：超高清横构图（3:2）。赫本风格收束画面，优雅纪实感。两人并肩行走于古典长廊，姿态从容优雅，衣摆微扬。远景中人物轮廓清晰，展现经典电影结尾般的诗意画面。 一、人物绑定（最高优先级） 人物：严格使用您上传的肖像。男性为新郎，身形挺拔，行走间体态舒展。女性为新娘，身形柔美优雅，体态轻盈挺拔，皮肤白皙通透，肤质细腻干净。肖像保真：100%沿用原图五官、脸型、肤色，禁止修改。远景中人物面部可稍小，但轮廓与姿态需清晰可辨。 二、造型细节 新娘：简约缎面修身婚纱，头纱向后微扬。珍珠耳饰随步伐轻轻摇曳。 新郎：黑色西装笔挺，领结精致。 三、场景与画质 场景：古典拱形长廊，透视纵深强烈。暖灰色调，柔光从长廊一侧透入。 光影与画质：远景中人物轮廓、头纱飘动轨迹、婚纱裙摆形态均需锐利清晰。长廊的光影透视增强了画面的叙事感和纵深。皮肤干净细腻。保留细腻胶片颗粒感，呈现经典黑白电影末尾般的诗意与余韵。 Negative Prompt: no slouching, no oily skin, no overexposure, no blurred face, no dull skin, no dark skin, no sallow complexion, no dirty skin, no rough skin, no blemishes, no tears, no crying, no sad expression, no loss of detail, no pixelation, no bright colors. 四、分镜动作 Wide landscape closing shot (3:2). The couple walks hand in hand down a long arched corridor, their elegant silhouettes framed by the receding columns. The bride turns her head slightly in three-quarter profile, her face catching the soft light from the side windows. Her veil and dress hem trail gracefully. The groom walks tall beside her, his posture refined. Timeless and poetic atmosphere, like the closing scene of a classic film. --ar 3:2`,
        aspectRatio: "3:2",
        scene: "赫本·永恒经典",
        pose: "G",
        styleTags: []
