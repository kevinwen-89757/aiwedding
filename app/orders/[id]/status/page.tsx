...
function progressInfo(order: Awaited<ReturnType<typeof getLocalOrder>>, normalized: string) {
  ...
  if (normalized === "pending_theme" || normalized === "pending_payment") return { progress: 20, stageText: "已收到上传信息，等待完成下一步", helperText: "完成付款和风格选择后，即可进入生成流程。", queueText: "", canAutoRefresh: false };
